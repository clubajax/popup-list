...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        browserify: {
            ...
            dev: {
                files: {
                    'tests/dist/output.js': ['tests/src/globals.js']
                },
                options: {
			...
			PopupList:{
            	files:{
            		'dist/popup-list.js': ['src/popup-list.js']
				},
				options: {
					external: [...vendorAliases],
					transform: babelTransform,
					browserifyOptions: {
						standalone: 'popup-list',
						debug: false
					}
				}
			},
            deploy: {
                files: {
                    'dist/popup-list.js': ['tests/src/globals.js']
                },
                options: {
					transform: babelTransform,
                    browserifyOptions: {
		...
		sass: {
			deploy: {
				...
				files: {
					'dist/popup-list.css': 'src/popup-list.scss'
				}
			},
			dev: {
				options: {
				...
				// 'path/to/result.css': 'path/to/source.scss'
				files: {
					'tests/dist/popup-list.css': 'src/popup-list.scss'
				}
			}
		},
        ...
        watch: {
			...
			css: {
				files: 'tests/dist/popup-list.css'
			},
            scripts: {
